        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row lg:gap-0 gap-12">
            ...
            <div className="lg:w-1/2 w-full border-b lg:border-b-0 lg:border-r border-gray-200 pr-0 lg:pr-12 pb-10 lg:pb-0">
              <div
                className="mb-8 animate__animated animate__fadeInUp"
              ...
              <ul>
                <li
                  className="flex items-center mb-8 animate__animated animate__fadeInRight"
                  style={{
                    paddingTop: "70px",
                    animationDelay: "0.3s",
                ...
                <li
                  className="flex items-center animate__animated animate__fadeInRight"
                  style={{
                    paddingTop: "20px",
                    animationDelay: "0.4s",
                    animationDuration: "1s",
                ...
                >
                  <div>
                    <svg width="48" height="48">
                      ...
                      />
                      <path
                        d="M15.1 17.8l-1.6-1.2c.4-.3.9-.5 1.4-.5h18c.5 0 1 .2 1.4.5l-1.5 1.2-8.5 6.6c-.3.2-.5.2-.8 0l-8.5-6.6zm20.2.1l-1.5 1.2-8.4 6.6c-.4.4-1 .6-1.5.6s-1.2-.2-1.6-.6l-8.3-6.6-1.5-1.2c-.1.2-.2.5-.2.7v11.5c0 1.3 1.1 2.4 2.5 2.4h18c1.3 0 2.4-1.1 2.4-2.4V18.6c0-.2-.1-.5-.2-.7z"
                        fill="#fff"
                      />
                    </svg>
                  </div>
              ...
              {/* Socials */}
              <div
                className="flex justify-center flex-wrap gap-10 mt-10 animate__animated animate__fadeInUp"
                style={{ marginLeft: "-10px" }}
              >
                <a
                  href="#"
                  className="flex items-center justify-center w-12 h-12 border rounded-full text-[#f2ab3c] bg-gray-100 hover:bg-[#f2ab3c] hover:text-white transition duration-300"
                >
            ...
            {/* Right: Demo Form */}
            <div
              className="lg:w-1/2 w-full flex flex-col justify-center pl-0 lg:pl-12 animate__animated animate__fadeInLeft"
              style={{ animationDelay: "0.3s", animationDuration: "1s" }}
            >
                ...
                <form className="space-y-12" onSubmit={handleSubmit}>
                  ...
                  <div className="pt-8">
                    ...
                    >
                      ...
                      >
                        <path
                          d="M18 5.8a1.2 1.2 0 00-.2-.3l-5-5a1.2 1.2 0 00-1.7 0 1.2 1.2 0 000 1.7l3.3 3.3H1.1A1.1 1.1 0 000 6.1a1.1 1.1 0 001.1 1.1h13.6l-3.3 3.3a1.2 1.2 0 001.7 1.7l5-5a1.2 1.2 0 00.2-1.5z"
                          fill="currentColor"
                        />
                      </svg>
                    </button>
