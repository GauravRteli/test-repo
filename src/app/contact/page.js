          ...
          <div className="flex flex-col xl:flex-row gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-20">
            ...
            <div className="w-full xl:w-1/2 flex flex-col justify-center xl:pl-8 lg:pl-10 xl:pl-12 animate__animated animate__fadeInLeft">
              <div className="mb-6 sm:mb-8 md:mb-10">
                ...
                <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-800 mb-3 sm:mb-4 lg:mb-6">
              ...
              {submitted ? (
                <div className="text-green-800 text-center bg-gradient-to-r from-green-50 to-green-100 border border-green-200 px-4 sm:px-6 md:px-8 py-6 sm:py-8 md:py-10 rounded-xl lg:rounded-2xl font-semibold shadow-lg animate__animated animate__fadeIn">
                  <div className="mb-2 sm:mb-4 text-xl sm:text-2xl md:text-3xl lg:text-4xl">
                    <i className="fas fa-check-circle text-green-600 mb-2 sm:mb-4"></i>
                    <div>Thank you!</div>
                  </div>
