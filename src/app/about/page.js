  ...
  return (
    <>
      ...
      <section 
        ...
        style={{backgroundImage: "url('/assets/images/pro/Component 127.png')"}}
      >
  ...
  <div className="flex flex-col lg:flex-row items-center">
    ...
    <div className="lg:w-1/2 h-full flex flex-col justify-center text-black space-y-6 px-8 lg:px-12">
      ...
      <p className="text-justify leading-relaxed text-base">
        We're a fast-growing FinTech startup, backed by our own NBFC, on a mission to revolutionize earnings management. Our Earnings on Demand solution empowers employees with secure, transparent, and responsible access to their earned salary —whenever they need it.
      </p>
      <p className="text-justify leading-relaxed text-base">
        The traditional monthly pay cycle leaves employees financially strained, pushing many toward high-interest loans or risky borrowing. AGI Moneey bridges this gap, turning every day into payday. With real-time access to earned income, we reduce financial stress, boost productivity, and prevent debt traps—creating a movement toward true financial wellness.
      </p>
      <p className="font-bold text-xl">We are making every day a payday</p>
    </div>
  </div>
</div>
      ...
      <div className="animate-on-scroll">
        <section className="py-24 px-4 lg:px-0">
          <div className="container mx-auto max-w-7xl">
            <div className="flex flex-col lg:flex-row gap-8 mb-12">
              <div className="lg:w-2/3">
                <h2 className="text-xl uppercase tracking-wider text-[#F2AB3C] mb-4">our vision</h2>
          ...
          >
            To be India's Most Pioneer & Reliable<br /> Salary on Demand Platform
          </motion.h2>
                </h2>
              </div>
            ...
            viewport={{ once: true, amount: 0.3 }}
          >
            At AGI Moneey, we envision a future where employees have seamless, instant, and responsible access to their hard-earned wages—because financial freedom shouldn't wait
          </motion.p>
              </div>
            </div>
            ...
            <div className="mb-12">
              <p className="text-gray-700 leading-relaxed">
                We are committed to transforming the way employees manage their finances by providing a flexible, transparent, and ethical Salary on Demand solution. Our vision goes beyond tradition payroll system; it's about empowering employees, enhancing workplace productivity, and breaking the cycle of debt traps
              </p>
            </div>
        ...
        <section className="py-24 px-4 lg:px-0">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              <h2 className="text-xl uppercase tracking-wider text-[#F2AB3C] mb-4">agi moneey</h2>
              <h2 className="text-3xl lg:text-4xl font-bold mb-6">Our Story</h2>
              <p className="text-gray-700 max-w-4xl mx-auto leading-relaxed">
                <span className="hidden lg:block">
                  AGI Moneey was founded on a simple truth: employees shouldn't wait weeks to access their hard-earned<br />
                  moneey. We reinvented India's payroll system with instant, responsible salary access—because financial needs<br />
                  don't follow a monthly calendar. Today, our Earnings on Demand solution empowers workers, boosts productivity,<br />
                  and breaks debt cycles
                </span>
                <span className="lg:hidden">
                  AGI Moneey was founded on a simple truth: employees shouldn't wait weeks to access their hard-earned moneey. We reinvented India's payroll system with instant, responsible salary access—because financial needs don't follow a monthly calendar. Today, our Earnings on Demand solution empowers workers, boosts productivity, and breaks debt cycles
                </span>
              </p>
            </div>
    ...
    <div>
      ...
      <div className="pt-24">
        ...
        <p className="text-gray-600">
          <span className="hidden lg:block">
            Salaried Indians face <br />cash shortages<br /> between salary cycle, <br />forcing expensive loans. <br />This stress hurts <br />productivity and traps <br />workers in endless debt cycles
          </span>
          <span className="lg:hidden">
            Salaried Indians face cash shortages between salary cycle, forcing expensive loans. This stress hurts productivity and traps workers in endless debt cycles
          </span>
        </p>
      </div>
    </div>
  ...
  <div className="process-card relative">
    <div>
      ...
      <div className="pt-24">
        ...
        <p className="text-gray-600">
          <span className="hidden lg:block">
            Our payroll integration <br />provides instant earned <br />wage access, giving<br /> employees financial<br /> relief while boosting <br />workplace satisfaction <br />and retention rates
          </span>
          <span className="lg:hidden">
            Our payroll integration provides instant earned wage access, giving employees financial relief while boosting workplace satisfaction and retention rates
          </span>
        </p>
      </div>
    </div>
  ...
  <div className="process-card relative">
    <div>
      ...
      <div className="pt-24">
        ...
        <p className="text-gray-600">
          <span className="hidden lg:block">
            Employees escape debt <br />traps, businesses<br /> improve retention, and <br />predatory lending <br />decreases through our<br /> responsible financial <br />access solution
          </span>
          <span className="lg:hidden">
            Employees escape debt traps, businesses improve retention, and predatory lending decreases through our responsible financial access solution
          </span>
        </p>
      </div>
    </div>
  ...
  <div className="process-card relative">
    <div>
      ...
      <div className="pt-24">
        ...
        <p className="text-gray-600">
          <span className="hidden lg:block">
            By 2026, we'll serve 1M+ <br />employees while<br /> expanding into<br /> insurance, micro<br />-investments, and<br /> financial education—<br />building true economic resilience
          </span>
          <span className="lg:hidden">
            By 2026, we'll serve 1M+ employees while expanding into insurance, micro-investments, and financial education—building true economic resilience
          </span>
        </p>
      </div>
    </div>
          ...
          <div className="container mx-auto max-w-7xl">
            <div className="flex flex-col lg:flex-row gap-8 items-center">
              <div className="lg:w-1/2">
                <img src="/assets/images/4.png" alt="Mission" className="w-full max-w-lg mx-auto" />
              </div>
              <div className="lg:w-1/2 flex flex-col justify-center">
                <h2 className="text-base uppercase tracking-wider text-[#F2AB3C] mb-4">our mission</h2>
                <h2 className="text-3xl lg:text-4xl font-bold mb-6">Making Any Day A Pay Day</h2>
                <div className="space-y-6 text-gray-700 leading-relaxed">
                  <p>
                    At AGI Moneey, our mission is to empower India's workforce by transforming how salaries are accessed and managed—through trusted partnerships with employers.
                  </p>
                  <p>
                    We work hand-in-hand with organizations to provide their employees with instant, responsible access to earned salary, without waiting for payday. By disbursing salary advances on behalf of the employer, we eliminate the need for costly loans, reduce financial stress, and foster a more stable, productive workforce.
                  </p>
                  <p>
                    Through our transparent, tech-driven platform, we are not just solving a financial problem—we are creating a new standard of flexibility, dignity, and control for every worker. Our goal is a future where financial freedom starts the moment you earn it, and no employee has to choose between urgent needs and long-term well-being.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto max-w-7xl px-4 text-center">
            <div className="space-y-6">
              ...
              <span className="text-gray-300 block">
                Whether you're an employer looking to offer smarter salary solutions, AGI Moneey is here to support you
              </span>
              <div className="pt-4">
                <a 
                  href="#" 
      ...
      <div className="animate-on-scroll">
        <section className="py-24 px-4 lg:px-0">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              <h2 className="text-base uppercase tracking-wider text-[#F2AB3C] mb-4">Our Team</h2>
              <h2 className="text-3xl lg:text-4xl font-bold mb-6">Meet The Team Behind AGI Moneey</h2>
              <p className="text-gray-700 max-w-3xl mx-auto">
                From strategy to delivery, our dedicated team combines creativity, expertise, and integrity to excel at every challenge.
              </p>
            </div>
              ...
              >
                <SwiperSlide>
                  <div className="bg-gray-100 rounded-lg p-6 text-center">
                    ...
                    <p className="text-gray-700 text-sm leading-relaxed mb-6 h-44">
                      Management Consultant with 15+ years in NBFCs, demonstrating deep financial sector and regulatory expertise. Currently leads a payday loan NBFC. Diversified experience in hospitality and infrastructure sectors highlights entrepreneurial versatility and operational leadership
                    </p>
                ...
                <SwiperSlide>
                  <div className="bg-gray-100 rounded-lg p-6 text-center">
                    ...
                    <p className="text-gray-700 text-sm leading-relaxed mb-6 h-44">
                      Proven expertise in HR management, team development, and compliance solutions. Strong service industry strategist with exceptional analytical skills. Drives organizational growth through employee training programs and performance optimization initiatives
                    </p>
                    <div className="flex justify-center">
                      <a href="#" className="text-gray-600 hover:text-purple-600 transition-colors duration-300">
                        <i className="fab fa-linkedin-in text-lg"></i>
                ...
                <SwiperSlide>
                  <div className="bg-gray-100 rounded-lg p-6 text-center">
                    ...
                    <p className="text-gray-700 text-sm leading-relaxed mb-6 h-44">
                      Financial expert with 10+ years' experience in advisory services. Specializes in RBI compliance, tax planning, and financial analysis. Ensures robust fiscal management through strategic planning and regulatory adherence
                    </p>
                    <div className="flex justify-center">
                      <a href="#" className="text-gray-600 hover:text-purple-600 transition-colors duration-300">
                        <i className="fab fa-linkedin-in text-lg"></i>
                ...
                <SwiperSlide>
                  <div className="bg-gray-100 rounded-lg p-6 text-center">
                    ...
                    <p className="text-gray-600 mb-4">VICE PRESIDENT (FINANCE)</p>
                    <p className="text-gray-700 text-sm leading-relaxed mb-6 h-44">
                      Expert in NBFC product design, risk assessment, and capital raising. Brings deep knowledge of MIS reporting, financial projections, and taxation. Delivers data-driven financial strategies for business growth
                    </p>
                    <div className="flex justify-center">
                      <a href="#" className="text-gray-600 hover:text-purple-600 transition-colors duration-300">
                        <i className="fab fa-linkedin-in text-lg"></i>
        ...
        <section className="py-24 px-4 lg:px-0">
          <div className="container mx-auto max-w-7xl">
            <div className="flex flex-col lg:flex-row gap-12">
              <div className="lg:w-1/3">
                <h2 className="text-xl uppercase tracking-wider text-[#F2AB3C] mb-4">Our culture</h2>
                <h2 className="text-3xl lg:text-4xl font-bold mb-6">Work Environment</h2>
                <p className="text-gray-700 text-lg leading-relaxed">
                  At AGI Moneey, our culture is the foundation of everything we build. We are guided by these core values
                </p>
              </div>
              <div className="lg:w-2/3">
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="feature-box1 p-8 rounded-2xl bg-gray-50">
                    <div className="mb-6">
                      <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="pulse">
                        <rect width="64" height="64" rx="16" fill="#F9F9F9"/>
                        <path fillRule="evenodd" clipRule="evenodd" d="M17.7149 15.3333H36.7626C38.0775 15.3333 39.1435 16.3993 39.1435 17.7143V36.7619C39.1435 38.0768 38.0775 39.1428 36.7626 39.1428H17.7149C16.4 39.1428 15.334 38.0768 15.334 36.7619V17.7143C15.334 16.3993 16.4 15.3333 17.7149 15.3333ZM45.4927 24.8571H46.2864C47.6013 24.8571 48.6673 25.9231 48.6673 27.2381V46.2857C48.6673 47.6007 47.6013 48.6666 46.2864 48.6666H27.2387C25.9238 48.6666 24.8578 47.6007 24.8578 46.2857V45.492H41.5245C43.7161 45.492 45.4927 43.7154 45.4927 41.5238V24.8571Z" fill="#2FA62B"/>
                        <path opacity="0.3" d="M40.7306 20.0952H41.5243C42.8392 20.0952 43.9052 21.1612 43.9052 22.4762V41.5238C43.9052 42.8388 42.8392 43.9047 41.5243 43.9047H22.4767C21.1617 43.9047 20.0957 42.8388 20.0957 41.5238V40.7301H36.7624C38.954 40.7301 40.7306 38.9535 40.7306 36.7619V20.0952Z" fill="#2FA62B"/>
                      </svg>
                    </div>
                    <h3 className="text-lg font-bold uppercase mb-3">Collaborate with Purpose</h3>
                    <p className="text-gray-600">We foster open dialogue, respect diverse ideas, and succeed together as one team</p>
                  </div>
                  ...
                  <div className="feature-box1 p-8 rounded-2xl bg-gray-50">
                    <div className="mb-6">
                      <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="pulse">
                        <rect width="64" height="64" rx="16" fill="#F9F9F9"/>
                        <path opacity="0.3" d="M37.5562 39.1429V46.2857C37.5562 47.6007 36.4902 48.6667 35.1753 48.6667H17.7149C16.4 48.6667 15.334 47.6007 15.334 46.2857V28.8254C15.334 27.5104 16.4 26.4445 17.7149 26.4445H24.8578V35.1746C24.8578 37.3662 26.6344 39.1429 28.826 39.1429H37.5562Z" fill="#A96EDD"/>
                        <path fillRule="evenodd" clipRule="evenodd" d="M28.8263 15.3334H46.2866C47.6015 15.3334 48.6675 16.3994 48.6675 17.7143V35.1746C48.6675 36.4896 47.6015 37.5556 46.2866 37.5556H28.8263C27.5113 37.5556 26.4453 36.4896 26.4453 35.1746V17.7143C26.4453 16.3994 27.5113 15.3334 28.8263 15.3334Z" fill="#A96EDD"/>
                      </svg>
                    </div>
                    <h3 className="text-lg font-bold uppercase mb-3">Act with Integrity</h3>
                    <p className="text-gray-600">We lead with honesty, transparency, and an unwavering commitment to doing the right thing</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto max-w-7xl">
            <div className="bg-gray-100 rounded-3xl p-12 text-center">
              ...
              <p className="text-gray-700 text-lg leading-relaxed max-w-3xl mx-auto mb-8">
                Join the AGI Moneey team and be part of a mission that's changing the way people access<br className="hidden lg:block" />
                their earnings. Let's innovate, grow and make a difference together!
              </p>
              <a 
